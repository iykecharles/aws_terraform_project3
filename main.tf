...
#***aws_codestarconnections_connection******aws_codestarconnections_connection******aws_codestarconnections_connection******aws_codestarconnections_connection******aws_codestarconnections_connection***
resource "aws_codestarconnections_connection" "github_connection" {
  name          = "charles316-aws-terraform-project"
  provider_type = "GitHub"
}


#***code build***##***code build***##***code build***##***code build***##***code build***##***code build***##***code build***##***code build***##***code build***##***code build***##***code build***#
...
data "aws_iam_policy_document" "example" {
  ...
  statement {
    ...
    resources = ["arn:aws:ec2:us-east-1:827950560876:network-interface/*"]
...
resource "aws_codedeploy_deployment_group" "aws_terraform_project" {
  ...
  deployment_group_name = "aws_terraform_project"
